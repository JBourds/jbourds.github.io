...
<main id="main" class="main grid-layout">
    ...
    <section class="aboutMe shadow">
        ...
        <a href="resume.html#projects" class="block aboutMe">Check out my Coding Projects!</a>
        <a href="https://www.openpowerlifting.org/u/jordanbourdeau" class="block aboutMe">Check out my Open Powerlifting Page!</a>
    </section>
